...
import { DerivativesFrom } from 'shared/containers/Swap/DerivativesForm'

const DerivativesPage = (): JSX.Element => {
  ...
  return (
    <Box className={classes.wrapper}>
      ...
      <Box className={classes.leftContainer}>
        ...
        <Box className={clsx(classes.block, classes.marginData)}>
          <MarginData />
        </Box>
        <Box className={clsx(classes.block, classes.desc)}>
